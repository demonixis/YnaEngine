...
namespace Yna.Display.TiledMap
{
    ...
    public class TiledMap
    {
        ...
        public TiledMap(string tilesetName, Layer[] layers, int tileSize)
        ...
        public TiledMap(string tilesetName, Layer[] layers, int tileWidth, int tileHeight)
        {
                ...
                for (int x = 0; x < _mapWidth; x++)
                {
                    for (int y = 0; y < _mapHeight; y++)
                    {
                           ...
                           && position.Y < drawZone.Y + drawZone.Height)
                        {
                            ...
                            spriteBatch.Draw(_tileset, position, rec, Color.White, 0.0f, Vector2.Zero, Vector2.One, SpriteEffects.None, 1.0f);
                        }
                    }
                }
            }
