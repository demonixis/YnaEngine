...
namespace Yna.Samples.Screens
{
    ...
    {
        YnEntity3DGeometry cylinder;
        YnEntity3DGeometry cone;
            ...
            : base(name, true)
        {
            ...
            cylinder = new YnEntity3DGeometry(cylinderGeometry, new BasicMaterial("Textures/metal"));
            Add(cylinder);

            cone = new YnEntity3DGeometry(coneGeometry, new BasicMaterial("Textures/metal"));
            Add(cone);
        }
