...
namespace Yna.Engine.Graphics3D.Cameras
{
    ...
    public class Camera : YnEntity
    {
        ...
        {
            SetupCamera(new Vector3(0.0f, 0.0f, 5.0f), Vector3.Forward, 1.0f, 3500.0f);
        }
        ...
        public virtual void Rotate(Vector3 rotation) => Rotate(ref rotation);
        ...
        /// </summary>
        /// <param name="rotation">Vector to use for rotation.</param>
        public virtual void SetRotation(Vector3 rotation) => SetRotation(ref rotation);
        ...
        public virtual void Translate(float x, float y, float z)
        {
            ...
            var forwardMovement = Matrix.CreateRotationY(_yaw);
        ...
        public virtual void Translate(Vector3 position) => Translate(ref position);

        /// <summary>
        /// Translate the camera. Values are transformed and added to the current position.
        /// </summary>
        /// <param name="position">Translation vector to use.</param>
        public virtual void Translate(ref Vector3 position) => Translate(position.X, position.Y, position.Z);
